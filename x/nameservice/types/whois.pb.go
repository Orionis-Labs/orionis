...
func init() {
	proto.RegisterType((*Whois)(nil), "orionislabs.orionis.nameservice.Whois")
}
...
var fileDescriptor_ffb1e5b15fe01e48 = []byte{
	...
	0xd6, 0x83, 0xb2, 0xf5, 0x90, 0x14, 0x4b, 0x89, 0xa4, 0xe7, 0xa7, 0xe7, 0x83, 0xd5, 0xea, 0x83,
	0x58, 0x10, 0x6d, 0x4a, 0xc9, 0x5c, 0xac, 0xe1, 0x20, 0x53, 0x84, 0x24, 0xb8, 0xd8, 0x93, 0x8b,
	0x52, 0x13, 0x4b, 0xf2, 0x8b, 0x24, 0x18, 0x15, 0x18, 0x35, 0x38, 0x83, 0x60, 0x5c, 0x21, 0x3e,
	0x2e, 0xa6, 0xcc, 0x14, 0x09, 0x26, 0x05, 0x46, 0x0d, 0x96, 0x20, 0xa6, 0xcc, 0x14, 0x21, 0x29,
	0x2e, 0x8e, 0xd2, 0xbc, 0xcc, 0xc2, 0xd2, 0x54, 0xcf, 0x14, 0x09, 0x66, 0xb0, 0x52, 0x38, 0x5f,
	0x48, 0x84, 0x8b, 0xb5, 0xa0, 0x28, 0x33, 0x39, 0x55, 0x82, 0x05, 0x2c, 0x01, 0xe1, 0x38, 0xf9,
	...
	0x69, 0x92, 0x5e, 0x72, 0x7e, 0xae, 0x3e, 0xd4, 0xd1, 0xba, 0x20, 0x1f, 0xc0, 0x38, 0xfa, 0x15,
	0xfa, 0xc8, 0x1e, 0x2e, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0x3b, 0xdd, 0x18, 0x10, 0x00,
	0x00, 0xff, 0xff, 0x7f, 0x09, 0x2c, 0x07, 0x0c, 0x01, 0x00, 0x00,
}
...
func (m *Whois) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UniqueId) > 0 {
		...
		i = encodeVarintWhois(dAtA, i, uint64(len(m.UniqueId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.Id != 0 {
